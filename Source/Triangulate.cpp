...
int Triangulate(bool* checker, GeometricData* preProcData, )
{
...
int WriteMesh(delaunator::Delaunator d)
{
    ...
    int nTriangles = d.triangles.size() / 3;
    int index = 0;
    for (std::size_t i = 0; i < d.triangles.size(); i += 3)
    {
        index++;
        double tx1 = d.coords[2 * d.triangles[i]];         //tx0
        double ty1 = d.coords[2 * d.triangles[i] + 1];     //ty0
        double tx2 = d.coords[2 * d.triangles[i + 1]];     //tx1
        double ty2 = d.coords[2 * d.triangles[i + 1] + 1]; //ty1
        double tx3 = d.coords[2 * d.triangles[i + 2]];     //tx2
        double ty3 = d.coords[2 * d.triangles[i + 2] + 1]; //ty2
